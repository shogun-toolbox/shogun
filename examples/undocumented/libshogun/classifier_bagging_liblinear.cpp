...
int main(int argc, char** argv)
{
	...
	CBinaryLabels* pred = bm->apply_binary(train_feats);
	pred->get_int_labels().display_vector();
	
	CLibLinear* libLin = new CLibLinear(1.0, train_feats, train_labels);

...
public class features_simple_longint_modular {
	static {
		System.loadLibrary("modshogun");
	}

	public ArrayList parameter_list = new ArrayList();
	public features_simple_longint_modular() {
	...
	static ArrayList run(List para) {
		...
		LongIntFeatures a = new LongIntFeatures(A);
	...
	public static void main(String argv[]) {
		features_simple_longint_modular x = new features_simple_longint_modular();

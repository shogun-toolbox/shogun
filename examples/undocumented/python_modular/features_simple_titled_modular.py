...
# get first feature vector, set it

    a.set_feature_vector(array([1,4,0,0,0,9], dtype=float64), 0)

# set title to firt feature vector
    a.set_feature_title(0, "test_title_real")
    b.set_feature_title(0, "test_title_longint")
    c.set_feature_title(0, "test_title_byte")
...
# set title to first feature vector

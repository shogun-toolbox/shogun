...
TEST(SGMatrix2CVMatMemcpy, SGMatrix_to_CVMat_conversion_using_Memcpy)
{
	...
	Mat cvMat1 = SG2CVMatFactory::getMatrix<uint8_t>(A, SG2CV_MEMCPY);
	Mat cvMat2 = SG2CVMatFactory::getMatrix<int8_t>(A, SG2CV_MEMCPY);
	Mat cvMat3 = SG2CVMatFactory::getMatrix<uint16_t>(A, SG2CV_MEMCPY);
	Mat cvMat4 = SG2CVMatFactory::getMatrix<int16_t>(A, SG2CV_MEMCPY);
	Mat cvMat5 = SG2CVMatFactory::getMatrix<int32_t>(A, SG2CV_MEMCPY);
	Mat cvMat6 = SG2CVMatFactory::getMatrix<float32_t>(A, SG2CV_MEMCPY);
	Mat cvMat7 = SG2CVMatFactory::getMatrix<float64_t>(A, SG2CV_MEMCPY);	

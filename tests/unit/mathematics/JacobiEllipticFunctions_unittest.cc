 ...
 *
 * Authors: Soumyajit De, Viktor Gal, Heiko Strathmann, Bjoern Esser
 */
...
TEST(JacobiEllipticFunctions, ellipJC)
{
	Complex sn, cn, dn;
#ifdef HAVE_ARPREC
	JacobiEllipticFunctions::ellipJC(Complex(0.5,0.0), 0.0, sn, cn, dn);
	...
	JacobiEllipticFunctions::ellipJC(Complex(0.5,0.5), 0.0, sn, cn, dn);
	...
	JacobiEllipticFunctions::ellipJC(Complex(0.5,0.5), 0.5, sn, cn, dn);
	...
	JacobiEllipticFunctions::ellipJC(Complex(0.2,0.0), 0.99, sn, cn, dn);
	...
	JacobiEllipticFunctions::ellipJC(Complex(0.7,0.4), 0.9999999999999999,
		sn, cn, dn);
	...
	JacobiEllipticFunctions::ellipJC(Complex(0.5,0.5), 1.0L-1E-16,
		sn, cn, dn);
	...
	JacobiEllipticFunctions::ellipJC(Complex(0.7,0.4),

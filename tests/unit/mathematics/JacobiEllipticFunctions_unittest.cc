...
TEST(JacobiEllipticFunctions, ellPJC)
{
	Complex sn, cn, dn;
#ifdef HAVE_ARPREC
	CJacobiEllipticFunctions::ellPJC(Complex(0.5,0.0), 0.0, sn, cn, dn);
	...
	CJacobiEllipticFunctions::ellPJC(Complex(0.5,0.5), 0.0, sn, cn, dn);
	...
	CJacobiEllipticFunctions::ellPJC(Complex(0.5,0.5), 0.5, sn, cn, dn);
	...
	CJacobiEllipticFunctions::ellPJC(Complex(0.2,0.0), 0.99, sn, cn, dn);
	...
	CJacobiEllipticFunctions::ellPJC(Complex(0.7,0.4), 
	...
	CJacobiEllipticFunctions::ellPJC(Complex(0.5,0.5), 1.0L-1E-16, sn, cn, dn);

...
# Code from class_list.cpp.py (can't import module with dots in the name)
# plus base class detection
...
def entry(templateFile, input_file, root_dir, bin_dir):
    ...
    templateVars = {"classes" : classes, "data_path" : data_path}
...
# <template file> <output file> <shogun root dir> <test bin dir>

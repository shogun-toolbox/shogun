...
// fixture for tests that cover all SGObject classes
template <typename T>
...
//
//		auto file = some<CSerializableAsciiFile>(filename.c_str(), 'w');
//		ASSERT_TRUE(obj->save_serializable(file));
//		file->close();
//
//		CSGObject* loaded = create(obj->get_name(), obj->get_generic());
//		ASSERT_NE(loaded, nullptr);
//		file = some<CSerializableAsciiFile>(filename.c_str(), 'r');
//		ASSERT_TRUE(loaded->load_serializable(file));
//		file->close();
//

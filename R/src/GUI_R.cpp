...
bool CGUI_R::set_hmm(const mxArray* vals[])
{
	const mxArray* mx_p=vals[1];
	const mxArray* mx_q=vals[2];
	const mxArray* mx_a=vals[3];
...
bool CGUI_R::hmm_classify(mxArray* retvals[])
{
	CFeatures* f=gui->guifeatures.get_test_features();
	if (f)
	{
...
bool CGUI_R::get_svm(mxArray* retvals[])
{
...
bool CGUI_R::svm_classify(mxArray* retvals[])
{
	CFeatures* f=gui->guifeatures.get_test_features();
	if (f)
	{
...
bool CGUI_R::get_features(mxArray* retvals[], CFeatures* f)
{
	if (f)
	{
...
CFeatures* CGUI_R::set_features(const mxArray* vals[], int nrhs)
{
...
bool CGUI_R::get_version(mxArray* retvals[])
{
...
bool CGUI_R::get_labels(mxArray* retvals[], CLabels* label)
{
	if (label)
	{
...
CLabels* CGUI_R::set_labels(const mxArray* vals[])
{
...
CHAR* CGUI_R::get_mxString(const mxArray* s)
{
...
bool CGUI_R::get_kernel_matrix(mxArray* retvals[])
{
	CKernel* k = gui->guikernel.get_kernel();
...
bool CGUI_R::get_subkernel_weights(mxArray* retvals[])
{
	CKernel *kernel_ = gui->guikernel.get_kernel() ;
	INT degree=-1;
	INT length=-1;

...
namespace shogun
{
class CSimpleStreamFromSimpleFeatures: public CSimpleStream
{
public:
	/** 
	 * Default constructor
	 */
	CSimpleStreamFromSimpleFeatures();
	 ...
	 */
	CSimpleStreamFromSimpleFeatures(CFeatures* feat);

	/** 
	 * Constructor taking a SimpleFeatures object, and labels as args
	 * 
	 * @param feat SimpleFeatures object
	 * @param labels labels as float64_t*
	 */
	CSimpleStreamFromSimpleFeatures(CFeatures* feat, float64_t* labels);
	
	/** 
	 * Destructor
	 */
	virtual ~CSimpleStreamFromSimpleFeatures();
	...
	{
		return "SimpleStreamFromSimpleFeatures";

...
#include "lib/StringStreamFromStringFeatures.h"

using namespace shogun;

CStringStreamFromStringFeatures::CStringStreamFromStringFeatures()
	: CStringStream()
{
	init();
}

CStringStreamFromStringFeatures::CStringStreamFromStringFeatures(CFeatures* feat)
	: CStringStream()
{
	init();
	features=feat;
...
CStringStreamFromStringFeatures::CStringStreamFromStringFeatures(CFeatures* feat, float64_t* lab)
	: CStringStream()
{
	init();
	features=feat;
...
void CStringStreamFromStringFeatures::init()
{
	features=NULL;
	labels=NULL;
	vector_num=0;
...
#define GET_VECTOR(fname, conv, sg_type)				\
	void CStringStreamFromStringFeatures::fname			\

 ...
 */
#ifndef __STREAMING_STRINGASCII_H__

#define __STREAMING_STRINGASCII_H__
...
namespace shogun
{
class CStringAsciiStream: public CStringStream
{
public:
	/** 
	 * Default constructor
	...
	/** 
	 * Constructor taking AsciiFile object as argument
	 * 
	 * @param f CAsciiFile object from which to read
	 */
	CStringAsciiStream(CAsciiFile* f);

	/** 
	 * Destructor
	 */
	virtual ~CStringAsciiStream();
...
#endif //__STREAMING_STRINGASCII_H__

...
namespace shogun
{
class CStringStreamFromStringFeatures: public CStringStream
{
public:
	/** 
	 * Default constructor
	 */
	CStringStreamFromStringFeatures();
	 ...
	 */
	CStringStreamFromStringFeatures(CFeatures* feat);

	/** 
	 * Constructor taking a StringFeatures object, and labels as args
	 * 
	 * @param feat StringFeatures object
	 * @param labels labels as float64_t*
	 */
	CStringStreamFromStringFeatures(CFeatures* feat, float64_t* labels);
	
	/** 
	 * Destructor
	 */
	virtual ~CStringStreamFromStringFeatures();
	...
	{
		return "StringStreamFromStringFeatures";

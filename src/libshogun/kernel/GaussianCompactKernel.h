 ...
 */
class CGaussianCompactKernel: public CDotKernel
{
	public:
		/** default constructor
		 *
		 ...
		 *
		 * @return kernel type GAUSSIANCOMPACT
		 */
		virtual EKernelType get_kernel_type() { return K_GAUSSIANCOMPACT; }

		/** return the kernel's name
		 *
		 * @return name GaussianCompact
		 */
		inline virtual const char* get_name() const { return "GaussianCompactKernel"; }

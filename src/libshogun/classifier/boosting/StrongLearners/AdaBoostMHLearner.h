...
public:
   ...
   */
   ...
   float updateWeights(OutputInfo* pOutInfo, InputData* pData, vector<BaseLearner*>& pWeakHypothesis); //for fast resume process, because we calculate the weights of the samples based on the margin
   ...
   */
   ...
   /**
   * Print out the weights of the instances at the end of the learning process if the name of the output file is given.
   * \see run
   * \date 29/04/2010
   */
...
protected:
   ...
   */
   ...
   bool _fastResumeProcess; //Fast resume process (true), it will calculate only the error rate of the last iteration we've found in the shyp file.
   ////////////////////////////////////////////////////////////////
private:
   /**

...
class COctaveInterface : public CSGInterface
{
	public:
		...
		/*
		virtual void set_byte_sparsematrix(const TSparse<uint8_t>* matrix, INT num_feat, INT num_vec, LONG nnz);
		...
		virtual void set_word_sparsematrix(const TSparse<uint16_t>* matrix, INT num_feat, INT num_vec, LONG nnz);*/

		void set_byte_string_list(const T_STRING<uint8_t>* strings, INT num_str);
		...
		void set_word_string_list(const T_STRING<uint16_t>* strings, INT num_str);

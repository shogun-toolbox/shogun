...
class CMatlabInterface : public CSGInterface
{
	public:
		...
		virtual void get_shortreal_vector(SHORTREAL*& vector, int32_t& len);
		virtual void get_real_vector(DREAL*& vector, int32_t& len);
		virtual void get_short_vector(SHORT*& vector, int32_t& len);
		...
		virtual void get_shortreal_sparsematrix(TSparse<SHORTREAL>*& matrix, int32_t& num_feat, int32_t& num_vec);
		virtual void get_short_sparsematrix(TSparse<SHORT>*& matrix, int32_t& num_feat, int32_t& num_vec);
		...
		virtual void set_shortreal_sparsematrix(const TSparse<SHORTREAL>* matrix, int32_t num_feat, int32_t num_vec);
		virtual void set_short_sparsematrix(const TSparse<SHORT>* matrix, int32_t num_feat, int32_t num_vec);

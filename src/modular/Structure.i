...
%apply (T_STRING<char>* IN_STRINGS, int32_t NUM, int32_t MAXLEN) {(T_STRING<char>* names, int32_t num_values, int32_t maxlen)}
%apply (T_STRING<char>* IN_STRINGS, int32_t NUM, int32_t MAXLEN) {(T_STRING<char>* transform_type, int32_t num_values, int32_t maxlen)}

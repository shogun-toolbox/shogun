...
%apply (CSGString<char>** IN_STRINGS, int32_t NUM, int32_t MAXLEN) {(CSGString<char>** names, int32_t num_values, int32_t maxlen)}
%apply (CSGString<char>** IN_STRINGS, int32_t NUM, int32_t MAXLEN) {(CSGString<char>** transform_type, int32_t num_values, int32_t maxlen)}

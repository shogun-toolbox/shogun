...
class COctaveInterface : public CSGInterface
{
	public:
		...
		/*
		virtual void set_byte_sparsematrix(const SGSparseMatrix<uint8_t>* matrix, int32_t num_feat, int32_t num_vec, int64_t nnz);
		virtual void set_char_sparsematrix(const SGSparseMatrix<char>* matrix, int32_t num_feat, int32_t num_vec, int64_t nnz);
		virtual void set_int_sparsematrix(const SGSparseMatrix<int32_t>* matrix, int32_t num_feat, int32_t num_vec, int64_t nnz);
		virtual void set_shortreal_sparsematrix(const SGSparseMatrix<float32_t>* matrix, int32_t num_feat, int32_t num_vec, int64_t nnz);
		virtual void set_short_sparsematrix(const SGSparseMatrix<int16_t>* matrix, int32_t num_feat, int32_t num_vec, int64_t nnz);
		virtual void set_word_sparsematrix(const SGSparseMatrix<uint16_t>* matrix, int32_t num_feat, int32_t num_vec, int64_t nnz);*/

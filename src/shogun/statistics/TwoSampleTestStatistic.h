...
#ifndef TWO_SAMPLE_TEST_STATISTIC_H_
#define TWO_SAMPLE_TEST_STATISTIC_H_
...
public:
	 ...
	 */
	CTwoSampleTestStatistic(CFeatures* p_and_q, index_t m);
...
#endif /* TWO_SAMPLE_TEST_STATISTIC_H_ */

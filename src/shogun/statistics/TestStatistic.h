...
class CTestStatistic : public CSGObject
{
	public:
		 ...
		 *
		 * @param num_permutation_iterations how often permutation shall be done
		 */
		virtual void set_num_permutation_iterations(index_t num_permutation_iterations);
	...
	protected:
		...
		index_t m_num_permutation_iterations;

...
class CGMM : public CDistribution
{
	public:
		 ...
		 */
		float64_t train_em(float64_t min_cov=1e-9, index_t max_iter=1000,
		 ...
		 * @return log likelihood of training data
		 */
		float64_t train_smem(index_t max_iter=100, index_t max_cand=5,
		 ...
		 * @return mean
		 */
		virtual SGVector<float64_t> get_nth_mean(index_t num);
		 ...
		 */
		virtual void set_nth_mean(SGVector<float64_t> mean, index_t num);
		 ...
		 * @return covariance
		 */
		virtual SGMatrix<float64_t> get_nth_cov(index_t num);
		 ...
		 */
		virtual void set_nth_cov(SGMatrix<float64_t> cov, index_t num);
	...
	private:
		...
		void partial_em(index_t comp1, index_t comp2, index_t comp3,
				float64_t min_cov, index_t max_em_iter, float64_t min_change);

...
class CSVRLight: public CSVMLight
{
	public:
		...
		virtual void update_linear_component(
			int32_t* docs, index_t *label,
			index_t *active2dnum, float64_t *a, float64_t* a_old,
			index_t *working2dnum, int32_t totdoc,
		 ...
		 * @param totdoc
		 */
		void call_mkl_callback(float64_t* a, index_t* label, float64_t* lin, float64_t* c, int32_t totdoc);
	...
	protected:
		 ...
		 * @return fix index
		 */
		static index_t regression_fix_index2(

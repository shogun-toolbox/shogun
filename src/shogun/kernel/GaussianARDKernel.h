...
public:
	 ...
	 */
	virtual SGMatrix<float64_t> get_parameter_gradient(const std::pair<std::string, std::shared_ptr<const AnyParameter>>& param,
			index_t index=-1);
...
protected:
	 ...
	 */
	virtual float64_t get_parameter_gradient_helper(const std::pair<std::string, std::shared_ptr<const AnyParameter>>& param,

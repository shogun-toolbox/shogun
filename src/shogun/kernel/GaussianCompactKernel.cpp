...
CGaussianCompactKernel::CGaussianCompactKernel(int32_t size, float64_t width) : CGaussianKernel(size, width)
{
}

CGaussianCompactKernel::CGaussianCompactKernel(CDotFeatures* l, CDotFeatures* r,
                                                float64_t width, int32_t size) : CGaussianKernel(l, r, width, size)
{
}

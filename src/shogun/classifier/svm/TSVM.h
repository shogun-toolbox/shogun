...
{
/** @brief class TSVM */
class CTSVM : public CLinearMachine
{
	public:
		/** default constructor */
		CTSVM();
		...
		/** get classifier type
		 *
		 * @return classifier type TSVM
		 */
		virtual inline EClassifierType get_classifier_type() { return CT_TSVM; }
		...
		/** @return object name */
		inline virtual const char* get_name() const { return "TSVM"; }

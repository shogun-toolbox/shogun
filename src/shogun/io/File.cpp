...
void CFile::get_vector(bool*& vector, index_t& len)
{
	index_t* int_vector;
...
void CFile::get_matrix(bool*& matrix, index_t& num_feat, index_t& num_vec)
{
	uint8_t * byte_matrix;
...
void CFile::set_matrix(const bool* matrix, index_t num_feat, index_t num_vec)
{
...
void CFile::set_string_list(const SGString<bool>* strings, index_t num_str)
{

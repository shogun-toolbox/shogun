...
{
	SG_SDEBUG("entering InputParser::start_parser()\n")
    if (is_running())
    {
    ...
    SG_SDEBUG("leaving InputParser::start_parser()\n")
}
...
{
	SG_SDEBUG("entering InputParser::is_running()\n")
    bool ret;
    ...
    SG_SDEBUG("leaving InputParser::is_running(), returning %d\n", ret)
    return ret;
}
...
{
	SG_SDEBUG("entering InputParser::end_parser\n")
	SG_SDEBUG("joining parse thread\n")
	if (parse_thread.joinable())
		parse_thread.join();
    SG_SDEBUG("leaving InputParser::end_parser\n")
}

...
public:
	 ...
	 */
	void get_sparse_vector(SGSparseVectorEntry<T>* &vec, int32_t &len) override;
	 ...
	 * @param label label
	 */
	void get_sparse_vector_and_label(SGSparseVectorEntry<T>* &vec, int32_t &len, float64_t &label) override;

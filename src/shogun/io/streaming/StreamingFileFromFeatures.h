...
public:
	 ...
	 */
	StreamingFileFromFeatures(const std::shared_ptr<Features>& feat);
	 ...
	 */
	StreamingFileFromFeatures(const std::shared_ptr<Features>& feat, float64_t* lab);
	 ...
	 */
	virtual void set_features(const std::shared_ptr<Features>& feat)
	{
		ASSERT(feat)
		features=feat;
	}

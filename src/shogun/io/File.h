...
public:
	...
	virtual void get_matrix(
			int8_t*& matrix, index_t& num_feat, index_t& num_vec){};
	virtual void get_matrix(
	...
	virtual void get_sparse_vector(
			SGSparseVectorEntry<bool>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<uint8_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<int8_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<char>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<int32_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<uint32_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<int64_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<uint64_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<int16_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<uint16_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<float32_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<float64_t>*& entries, index_t& num_feat);
	virtual void get_sparse_vector(
			SGSparseVectorEntry<floatmax_t>*& entries, index_t& num_feat);
	//@}
	...
	virtual void get_sparse_matrix(
		SGSparseVector<uint8_t>*& matrix, index_t& num_feat,
		index_t& num_vec){};
	virtual void get_sparse_matrix(
	...
	virtual void get_sparse_matrix(
		SGSparseVector<int32_t>*& matrix, index_t& num_feat,
		index_t& num_vec){};
	virtual void get_sparse_matrix(
		SGSparseVector<uint32_t>*& matrix, index_t& num_feat,
		index_t& num_vec){};
	virtual void get_sparse_matrix(
		SGSparseVector<int64_t>*& matrix, index_t& num_feat,
		index_t& num_vec){};
	virtual void get_sparse_matrix(
		SGSparseVector<uint64_t>*& matrix, index_t& num_feat,
		index_t& num_vec){};
	virtual void get_sparse_matrix(
		SGSparseVector<int16_t>*& matrix, index_t& num_feat,
		index_t& num_vec){};
	virtual void get_sparse_matrix(
		SGSparseVector<uint16_t>*& matrix, index_t& num_feat,
		index_t& num_vec){};
	virtual void get_sparse_matrix(
	...
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<bool>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<uint8_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<int8_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<char>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<int32_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<uint32_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<int64_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<uint64_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<int16_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<uint16_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<float32_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<float64_t>* entries, index_t num_feat);
	virtual void set_sparse_vector(
			const SGSparseVectorEntry<floatmax_t>* entries, index_t num_feat);
	//@}

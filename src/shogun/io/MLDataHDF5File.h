...
public:
	...
	virtual void set_vector(const int8_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_vector(const uint8_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_vector(const char*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_vector(const int16_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_vector(const int32_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_vector(const uint32_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_vector(const float32_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	...
	virtual void set_vector(const uint16_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_vector(const int64_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_vector(const uint64_t*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const uint8_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const int8_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const char*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const int32_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const uint32_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const int64_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const uint64_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const float32_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const float64_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const floatmax_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const int16_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_matrix(const uint16_t*, index_t, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void
	...
	virtual void set_string_list(const shogun::SGString<bool>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<uint8_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<int8_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<char>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<int32_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<uint32_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<int16_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<uint16_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<int64_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<uint64_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<float32_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<float64_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	virtual void set_string_list(const shogun::SGString<floatmax_t>*, index_t)
	{
		SG_NOTIMPLEMENTED
	}
	/** @return object name */

...
void CCSVFile::get_matrix(sg_type*& matrix, index_t& num_feat, index_t& num_vec) \
{ \
	index_t num_lines=0; \
...
void CCSVFile::set_matrix(const sg_type* matrix, index_t num_feat, index_t num_vec) \
{ \
	SG_SET_LOCALE_C; \
	\
	if (!is_data_transposed) \

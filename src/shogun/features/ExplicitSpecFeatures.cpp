...
index_t CExplicitSpecFeatures::get_dim_feature_space() const
{
	return spec_size;
}
...
index_t CExplicitSpecFeatures::get_nnz_features_for_vector(index_t num)
{
	SG_NOTIMPLEMENTED
	return 0;
}
...
index_t CExplicitSpecFeatures::get_num_vectors() const
{
	return num_strings;
}

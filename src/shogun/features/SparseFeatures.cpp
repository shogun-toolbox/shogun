...
template<class ST> float64_t SparseFeatures<ST>::dense_dot(int32_t vec_idx1, const float64_t* vec2, int32_t vec2_len) const
{
...
template<> float64_t SparseFeatures<complex128_t>::dense_dot(int32_t vec_idx1,

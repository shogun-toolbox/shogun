...
float64_t HashedDocDotFeatures::dense_dot_sgvec(int32_t vec_idx1, const SGVector<float64_t> vec2) const
{
	return dense_dot(vec_idx1, vec2.vector, vec2.vlen);
}

float64_t HashedDocDotFeatures::dense_dot(int32_t vec_idx1, const float64_t* vec2, int32_t vec2_len) const
{

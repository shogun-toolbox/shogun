...
namespace shogun::graph::op {
	    ...
	    void* input1, void* input2, void* output)
	{
		...
		std::transform(vec1, vec1 + SSE_BYTESIZE/sizeof(bool), vec2, out, std::multiplies<bool>());
	}

	template<>
	void multiply_kernel_implementation_sse2<float>(
		void* input1, void* input2, void* output)
	{
	...
	template<>
	void multiply_kernel_implementation_sse2<double>(
		void* input1, void* input2, void* output)
	{
		static_cast<Packet*>(output)->m_data = pmul(
	...
	template<>
	void multiply_kernel_implementation_sse2<int16_t>(
		void* input1, void* input2, void* output)
	{
	...
	template<>
	void multiply_kernel_implementation_sse2<int32_t>(
		void* input1, void* input2, void* output)
	{
		static_cast<Packet*>(output)->m_data = pmul(
			std::get<Packet4i>(static_cast<const Packet*>(input1)->m_data), 
	...
	template void multiply_kernel_implementation_sse2<bool>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<int8_t>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<int16_t>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<int32_t>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<int64_t>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<uint8_t>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<uint16_t>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<uint32_t>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<uint64_t>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<float>(void*, void*, void*);
	template void multiply_kernel_implementation_sse2<double>(void*, void*, void*);
}
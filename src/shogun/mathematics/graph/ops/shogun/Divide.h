				...
				std::tuple<BinaryPacketFunction, RegisterType> kernel_implementation_packet() const
				{
					...
					if (CPU_arch->has_avx512f())
					{
						auto k = [](const Packet& packet1, const Packet& packet2, const Packet& output_packet){
							divide_kernel_implementation_avx512f<T>((void*)&packet1, (void*)&packet2, (void*)&output_packet);
						};
					...
					{
						auto k = [](const Packet& packet1, const Packet& packet2, const Packet& output_packet){
							divide_kernel_implementation_avx<T>((void*)&packet1, (void*)&packet2, (void*)&output_packet);
						};
					...
					{
						auto k = [](const Packet& packet1, const Packet& packet2, const Packet& output_packet){
							divide_kernel_implementation_sse2<T>((void*)&packet1, (void*)&packet2, (void*)&output_packet);
						};

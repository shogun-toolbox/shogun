...
namespace shogun
{
	namespace random
	{
		...
		template <
		    ...
		    std::enable_if_t<std::is_base_of<
		        ...
		        nullptr>
		static inline void seed(T* object, int64_t seed)
		{
			if (object->has(kSeed))
	...
	static inline void seed_callback(SGObject*, int64_t);
	...
	static inline void seed_callback(SGObject* obj, int64_t seed)
	{

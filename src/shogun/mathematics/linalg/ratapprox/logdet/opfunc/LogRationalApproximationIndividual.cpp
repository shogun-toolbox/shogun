...
CLogRationalApproximationIndividual::CLogRationalApproximationIndividual(
	...
	: CRationalApproximation(linear_operator, eigen_solver, desired_accuracy, OF_LOG)
{
	init();
...
float64_t CLogRationalApproximationIndividual::solve(
	SGVector<float64_t> sample)
{
	...
	for (index_t i=0; i<m_num_shifts; ++i)
	{
		...
		REQUIRE(shifted_op, "OperatorFunction::solve():"

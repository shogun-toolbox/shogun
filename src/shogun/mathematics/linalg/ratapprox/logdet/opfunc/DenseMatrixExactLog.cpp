...
float64_t CDenseMatrixExactLog::solve(SGVector<float64_t>
	sample)
{
	SG_DEBUG("Entering...\n");

	CDenseMatrixOperator<float64_t>* m_log_operator=dynamic_cast<CDenseMatrixOperator<float64_t>* >(m_linear_operator);

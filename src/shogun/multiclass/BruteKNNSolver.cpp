...
CMulticlassLabels* CBruteKNNSolver::classify_objects(
...
SGVector<index_t> CBruteKNNSolver::classify_objects_k(
    CDistance* knn_distance, const index_t num_lab,

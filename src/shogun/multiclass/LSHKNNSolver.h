...
class CLSHKNNSolver : public CKNNSolver
{
	public:
		 ...
		 * @param lsh_t m_lsh_t
		 */
		CLSHKNNSolver(const index_t k, const float64_t q, const index_t num_classes, const index_t min_label, const SGVector<index_t> train_labels, const index_t lsh_l, const index_t lsh_t);

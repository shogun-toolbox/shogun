...
template void CSGObject::cereal_save<cereal::BinaryOutputArchive>(cereal::BinaryOutputArchive& ar) const;
template void CSGObject::cereal_save<cereal::JSONOutputArchive>(cereal::JSONOutputArchive& ar) const;
template void CSGObject::cereal_save<cereal::XMLOutputArchive>(cereal::XMLOutputArchive& ar) const;
...
template void CSGObject::cereal_load<cereal::BinaryInputArchive>(cereal::BinaryInputArchive& ar);
template void CSGObject::cereal_load<cereal::JSONInputArchive>(cereal::JSONInputArchive& ar);
template void CSGObject::cereal_load<cereal::XMLInputArchive>(cereal::XMLInputArchive& ar);

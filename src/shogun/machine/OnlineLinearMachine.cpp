...
{
	SG_ADD(&m_w, paramVectorVar, "Parameter vector w.", ParameterProperties::MODEL);
	SG_ADD(&bias, biasVar, "Bias b.", ParameterProperties::MODEL);
	SG_ADD((std::shared_ptr<SGObject>*) &features, featureVar,
	    "Feature object.");
}

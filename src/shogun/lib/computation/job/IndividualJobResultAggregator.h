...
#include <shogun/lib/computation/job/StoreVectorAggregator.h>
...
public:
	 ...
	 */
	CIndividualJobResultAggregator(CLinearOperator<float64_t>* linear_operator,
		SGVector<float64_t> vector, const float64_t& const_multiplier);

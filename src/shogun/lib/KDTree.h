...
protected:
	...
	*/
	inline vector<float>& content() { return data; }
...
public:
	...
	* @return left node
	*/
	inline KDTNode* get_left() { return left; }

	/** get left subtree
	* @return left node
	*/
	inline KDTNode* get_right() { return right; }
	
	/** get left subtree
	* @return left node
	*/
	inline vector<float> get_data() { return data; }

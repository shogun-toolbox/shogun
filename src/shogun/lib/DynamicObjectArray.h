...
class CDynamicObjectArray : public CSGObject
{
	public:
		 ...
		 */
		inline void get_array_size(index_t& dim1, index_t& dim2)
		{
			dim1=dim1_size;
			dim2=dim2_size;
		}
		 ...
		 */
		inline void get_array_size(index_t& dim1, index_t& dim2, index_t& dim3)
		{
			dim1=dim1_size;
			dim2=dim2_size;
			dim3=dim3_size;
		 ...
		 */
		inline CSGObject* get_element(index_t index) const
		{
		 ...
		 * @return array element at index
		 */
		inline CSGObject* get_element_safe(index_t index) const
		{
		 ...
		 * @return if setting was successful
		 */
		inline bool insert_element(CSGObject* e, index_t index)
		{

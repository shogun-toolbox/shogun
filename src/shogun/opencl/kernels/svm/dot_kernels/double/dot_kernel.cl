...
* - Based on Karl Rupp's implementation of Matrix-Matrix product in ViennaCL
*/
...
__kernel void dot_kernel_double(
...
__local double * bufAptr = bufA + row_thread_id_times_block_size;
__local double * bufBptr = bufB + col_thread_id * block_size;
      double diff = 0;

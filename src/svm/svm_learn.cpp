...
void select_top_n(double *selcrit, long range,long* select, long n)
{
  register long i,j;
...
long shrink_problem(LEARN_PARM *learn_parm, SHRINK_STATE *shrink_state, long *active2dnum, 
...
void estimate_transduction_quality(MODEL *model, long *label, long* unlabeled, long totdoc, DOC *docs, double *lin)
{

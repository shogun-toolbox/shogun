...
#ifndef _WEIGHTEDDEGREEPOSITIONCHARKERNEL_NEW_H___
#define _WEIGHTEDDEGREEPOSITIONCHARKERNEL_NEW_H___
...
class CWeightedDegreePositionCharKernel_new: public CSimpleKernel<CHAR>
{
 ...
 public:
  CWeightedDegreePositionCharKernel_new(LONG size, DREAL* weights, INT degree, INT max_mismatch, 
					...
					INT mkl_stepsize=1) ;
  ~CWeightedDegreePositionCharKernel_new() ;
...
/*
inline DREAL CWeightedDegreePositionCharKernel_new::compute_by_tree_helper(INT* vec, INT len, INT seq_pos, 
									   INT tree_pos,
									   INT weight_pos)
{
  DREAL sum=0 ;

...
{
 public:
  CWeightedDegreeCharKernelPolyA(LONG size, REAL* weights, INT degree, INT max_mismatch) ;
 ...
 protected:
  ...
  REAL compute_with_offset(INT idx_a, INT offset_a, INT idx_b, INT offset_b) ;

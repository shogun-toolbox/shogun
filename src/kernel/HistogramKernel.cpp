...
#include "kernel/HistogramKernel.h"
...
CHistogramKernel::CHistogramKernel(long size, int d)
  : CKernel(size),degree(d)
{
}

CHistogramKernel::~CHistogramKernel() 
{
}
...
bool CHistogramKernel::load_init(FILE* src)
{
    assert(src!=NULL);
...
bool CHistogramKernel::save_init(FILE* dest)
{
...
REAL CHistogramKernel::compute(long idx_a, long idx_b)
{
  long alen, blen;

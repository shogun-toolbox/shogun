...
#ifndef __PERLINTERFACE__H_
#define __PYTHONINTERFACE__H_
#define __PERLINTERFACE__H_
...
class CPerlInterface : public CSGInterface
{
	public:
		CPythonInterface(PyObject* args);
		CPerlInterface(PyObject* args);
		CPythonInterface(PyObject* self, PyObject* args);
		CPerlInterface(PyObject* self, PyObject* args);
		~CPythonInterface();
		~CPerlInterface();
		...
		inline virtual const char* get_name() const { return "PerlInterface"; }

		static void run_python_init();
		static void run_perl_init();
		static void run_python_exit();
		static void run_perl_exit();
		static bool run_python_helper(CSGInterface* from_if);
		static bool run_perl_helper(CSGInterface* from_if);

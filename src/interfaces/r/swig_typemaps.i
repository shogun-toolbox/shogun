...
%typemap(in) shogun::SGVector<sg_type>
{
    ...
    {
        /*error("Expected Double Vector as argument %d\n", m_rhs_counter);*/
        SWIG_fail;
    }
...
%typemap(in) shogun::SGMatrix<sg_type>
{
    ...
    {
        /*error("Expected Double Matrix as argument %d\n", m_rhs_counter);*/
        SWIG_fail;
    }
...
%typemap(in) std::vector<shogun::SGVector<sg_type>>
{
    ...
    {
        /* error("Expected String List as argument %d\n", m_rhs_counter);*/
        SWIG_fail;
    }
    ...
    for (int32_t i=0; i<num_strings; i++)
    {
        ...
        {
            /*io::warn( "string with index {} has zero length.\n", i+1);*/
        }
    }
}
%enddef

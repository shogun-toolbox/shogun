...
TYPEMAP_IN_SGVECTOR(complex64_t,   NPY_CDOUBLE)
...
TYPEMAP_OUT_SGVECTOR(complex64_t,   NPY_CDOUBLE)
...
TYPEMAP_IN_SGMATRIX(complex64_t,   NPY_CDOUBLE)
...
TYPEMAP_OUT_SGMATRIX(complex64_t,   NPY_CDOUBLE)
...
TYPEMAP_SPARSEFEATURES_IN(complex64_t,   NPY_CDOUBLE)
...
TYPEMAP_SPARSEFEATURES_OUT(complex64_t,   NPY_CDOUBLE)

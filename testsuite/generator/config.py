...
CLASSIFIER={
	...
	'WDSVMOcas':[1e-4, 'wdsvmocas', 'twoclass'],
...
DISTRIBUTION={
	'Histogram':[['dna', ''], ['string_complex', 'Word', 'Char'], 1e-7],
...
KERNEL={
	...
	'SparsePoly':[['rand', 'double'], ['simple', 'Real'],
		['size', 'degree', 'inhomogene', 'use_normalization'], 1e-6],
	...
	'WeightedDegreeString':[['dna', ''], ['string', 'Char'], ['degree'], 1e-7],

...
acgt='ACGT';
traindat=[acgt(ceil(4*ones(len,num_train/2))) acgt(ceil(3*ones(len,num_train/4))) acgt(ceil(2*ones(len,num_train/4)))];
trainlab=[-ones(1,num_train/2),ones(1,num_train/2)];

traindat(1:20,trainlab==+1)='A';
traindat(21:40,trainlab==+1)='C';
traindat(41:60,trainlab==+1)='G';
traindat(61:100,trainlab==+1)='T';
traindat'
...
consensus'
sg('set_features', 'TEST', [ consensus ['G' consensus(1:end-1)']' traindat(:,end) ['CCCCCCCCCAAAAAAAAAAACCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC']' ], 'DNA');

...
find_file(ATLAS_LAPACK liblapack_atlas.so.3 PATHS /usr/lib /usr/lib64 $ENV{ATLASDIR} PATH_SUFFIXES atlas atlas-base)
find_library(ATLAS_LAPACK lapack_atlas PATHS $ENV{ATLASDIR})

if(NOT ATLAS_LAPACK)
  find_file(ATLAS_LAPACK liblapack.so.3 PATHS /usr/lib/atlas /usr/lib64/atlas $ENV{ATLASDIR})
  find_library(ATLAS_LAPACK lapack PATHS $ENV{ATLASDIR})

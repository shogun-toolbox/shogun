...
ENDIF ()
IF (NOT "${INTERFACE_LIBRARIES}" STREQUAL "")
    MESSAGE("Linking ${INTERFACE_TARGET} with ${INTERFACE_LIBRARIES}")
    SWIG_LINK_LIBRARIES(${INTERFACE_TARGET} "${INTERFACE_LIBRARIES}")
ELSE()
    MESSAGE("Using static linking for ${INTERFACE_TARGET}")
    IF ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
        SET_TARGET_PROPERTIES(${INTERFACE_REAL_NAME} PROPERTIES

			...
			if (TARGET ${element})
				...
				if (${TARGET_TYPE} STREQUAL INTERFACE_LIBRARY)
					...
					if (NOT ${TARGET_TYPE} STREQUAL OBJECT_LIBRARY)
						if (WIN32)
							# TODO: not sure if this is the right way to fix the linking
							# problem on windows, see https://github.com/shogun-toolbox/shogun/issues/3917
							target_link_libraries(${element} PUBLIC ${${LIBRARY_PREFIX}_LIBRARIES})
						else()

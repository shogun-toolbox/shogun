...
macro(ADD_LIBRARY_DEPENDENCY)
	...
	IF(${ADD_LIBRARY_DEPENDENCY_GPL_ONLY})
		IF(${ENABLE_${LIBRARY_PREFIX}} AND NOT USE_GPL_SHOGUN)
	    		MESSAGE(FATAL_ERROR "Can only use ${LIBRARY_PREFIX} when building Shogun with GPL codes. Disable by ENABLE_${LIBRARY_PREFIX}=OFF")
		ENDIF()
	ENDIF()

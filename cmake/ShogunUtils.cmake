...
function(SHOGUN_COMPILE_OPTS)
	...
	set(options)
	set(oneValueArgs)
	set(multiValueArgs CXX_OPTS C_OPTS)
	cmake_parse_arguments(COMPILE_OPTS ${options} ${oneValueArgs} ${multiValueArgs} ${ARGN})
	target_compile_options(libshogun ${SCOPE} $<$<COMPILE_LANGUAGE:CXX>:${COMPILE_OPTS_CXX_OPTS}>)
	target_compile_options(libshogun ${SCOPE} $<$<COMPILE_LANGUAGE:C>:${COMPILE_OPTS_C_OPTS}>)
	target_compile_options(shogun ${SCOPE} $<$<COMPILE_LANGUAGE:CXX>:${COMPILE_OPTS_CXX_OPTS}>)
	target_compile_options(shogun ${SCOPE} $<$<COMPILE_LANGUAGE:C>:${COMPILE_OPTS_C_OPTS}>)
	if (LIBSHOGUN_BUILD_STATIC)
		target_compile_options(shogun-static ${SCOPE} $<$<COMPILE_LANGUAGE:CXX>:${COMPILE_OPTS_CXX_OPTS}>)
		target_compile_options(shogun-static ${SCOPE} $<$<COMPILE_LANGUAGE:C>:${COMPILE_OPTS_C_OPTS}>)
	endif()
	target_compile_options(shogun_deps INTERFACE $<$<COMPILE_LANGUAGE:CXX>:${COMPILE_OPTS_CXX_OPTSj}>)
	target_compile_options(shogun_deps INTERFACE $<$<COMPILE_LANGUAGE:C>:${COMPILE_OPTS_C_OPTS}>)
endfunction()

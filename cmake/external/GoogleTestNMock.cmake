...
if(CMAKE_GENERATOR MATCHES "Visual Studio.*" OR CMAKE_GENERATOR STREQUAL Xcode)
	set_target_properties(gtest PROPERTIES
		IMPORTED_LOCATION_DEBUG "${GTEST_DIR}/Debug/${CMAKE_STATIC_LIBRARY_PREFIX}gtestd${CMAKE_STATIC_LIBRARY_SUFFIX}"
...
if(CMAKE_GENERATOR MATCHES "Visual Studio.*" OR CMAKE_GENERATOR STREQUAL Xcode)
	set_target_properties(gmock PROPERTIES
		IMPORTED_LOCATION_DEBUG "${GMOCK_DIR}/Debug/${CMAKE_STATIC_LIBRARY_PREFIX}gmockd${CMAKE_STATIC_LIBRARY_SUFFIX}"
